...
from app.models.schemas import PaperTradeOut, AssetClass
...
def test_paper_trade_receipt_creation():
    ...
    # Create a mock paper trade for testing (similar to what would come from paper_trading_engine)
    trade_no_license = PaperTradeOut(
        id=str(uuid.uuid4()),
        user_id="test-user-123",
        asset="AAPL",
        asset_class=AssetClass.STOCK,
